...
namespace test1
{
    internal class Utils
    {
        ...
        public static Wall CreateWall(Document document, UV point_1, UV point_2, Level level, string name,int num = 300)
        {
            WallType wallType = new FilteredElementCollector(document)
                .OfClass(typeof(WallType))
                .WhereElementIsElementType()
                .Cast<WallType>()
                .FirstOrDefault(x => x.Name == "Generic - "+ num + "mm"); // Set your own selected wall type in your Revit
            Wall wall = null;
        ...
        public static Floor CreateFloor(Document document, UV point_1, UV point_2, UV point_3, UV point_4, Level level, string name)
        {
            ...
            FloorType floorType = new FilteredElementCollector(document)
                ...
                .WhereElementIsElementType()
                .Cast<FloorType>()
                .FirstOrDefault(x => x.Name == "Generic Floor - 120mm"); // Set your own selected floor type in your Revit
            Floor floor = null;
            using (Transaction tr = new Transaction(document, "create_floor"))
            {
                ...
                loop.Append(line_3);
                loop.Append(line_4);
                floor = document.Create.NewFloor(loop,false);
        ...
        public static FamilyInstance CreateWindow(Document document, UV point, Wall wall, Level level)
        {
            ...
            double window_height = level.ProjectElevation + 1200 / 304.8;
        ...
        public static Wall FindSharedWall(Document document, NowRoom room_1, NowRoom room_2, Level level)
        {
        ...
        public static FamilyInstance CreateDoorBetweenRooms(Document document, NowRoom room_1, NowRoom room_2, Level level)
        {
            UV point_1 = room_1.GetSouthwestPoint();
            UV point_2 = room_1.GetSoutheastPoint();
            UV point_3 = room_1.GetNortheastPoint();
        ...
        public static FamilyInstance CreateDoorOrWindowBetweenRoomAndExternalSpace(Document document, NowRoom room, Level level, string direction, string type)
        {
            Wall wall = null;
            if (direction == "north")
            {
