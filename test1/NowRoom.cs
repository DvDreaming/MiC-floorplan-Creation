...
namespace test1
{
    internal class NowRoom
    {
        ...
        public NowRoom(Document document, Module module, Level level, string name)
        {
        ...
        public NowRoom(Document document, Module module, UV point_1, UV point_2, UV point_3, UV point_4, Level level, string name)
        {
            this.document = document;
        ...
        public NowRoom(Document document, Module module, UV central_point, double north_south_length, double east_west_length, Level level, string name)
        {
            this.document = document;
        ...
        public NowRoom(Document document, Module module, string direction, double length, Level level, string name)
        {
            this.document = document;
            UV point_1;
            UV point_2;
        ...
        public NowRoom(Document document, Module module, string corner, double north_south_length, double east_west_length, Level level, string name)
        {
            this.document = document;
            UV point_1;
            UV point_2;
